...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['addData'])) {
    ...
    $sql = "INSERT INTO AssetInventory (Date, InvoiceNo, Assets, Qty, Location, DeviceSerialNumber, SubLocation, REFNO, Supplier, Cost, DepRate, Status)
            VALUES ('$date', '$invoiceNo', '$assets', $qty, '$location', '$deviceSerialNumber', '$subLocation', '$refNo', '$supplier', $cost, '$depRate', '$status')";
...
<div class="container">
    <h2>Computer Software Data Adding Form!</h2>
